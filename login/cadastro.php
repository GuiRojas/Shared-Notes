...
<body>
	...
	<div id="cadastro">
		...
		if(isset($_POST['username'])&&isset($_POST['senha'])&&isset($_POST['senha_conf'])&&isset($_POST['email'])&&isset($_POST['nome'])){
			...
			$_POST['username'] = $_POST['username'],$conexao;
			$_POST['senha'] = $_POST['senha'],$conexao;
			$_POST['senha_conf'] = $_POST['senha_conf'],$conexao;
			$_POST['email'] = $_POST['email'],$conexao;
			$_POST['nome'] = $_POST['nome'],$conexaos;
